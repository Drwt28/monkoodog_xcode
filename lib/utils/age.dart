...
class AgeDuration {
  ...
  AgeDuration({this.days = 0, this.months = 0, this.years = 0, this.weeks =0});

  String toString() {
    return 'Years: $years, Months: $months, Days: $days, Weeks: ${years*52 + months*4}';
  }
}
...
class AgeWeeks {
  ...
  AgeWeeks({this.days = 0, this.months = 0, this.years = 0, this.weeks =0});

  String toString() {
    return '${years*52 + months*4} weeks';
  }
}
...
class Age {
  ...
  static AgeDuration dateDifference(
    ...
    return AgeDuration(weeks: years*52 + months*4);
  }

  static AgeWeeks weeks(
      {@required DateTime fromDate,
        @required DateTime toDate,
        bool includeToDate = false}) {
    // Check if toDate to be included in the calculation
    ...
    return AgeWeeks(days: days, months: months, years: years);
  }
